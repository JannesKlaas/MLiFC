# Course glossary and lookup file
...
- [Lists cheat sheet](https://github.com/ehmatthes/pcc/releases/download/v1.0.0/beginners_python_cheat_sheet_pcc_lists.pdf)
- [Lists tutorial](https://developers.google.com/edu/python/lists)

- [Dictionaries cheat sheet](https://github.com/ehmatthes/pcc/releases/download/v1.0.0/beginners_python_cheat_sheet_pcc_dictionaries.pdf)
- [Dictionary tutorial](https://developers.google.com/edu/python/dict-files)

- [If statement and Loops cheat sheet](https://github.com/ehmatthes/pcc/releases/download/v1.0.0/beginners_python_cheat_sheet_pcc_if_while.pdf)
- [Loops tutorial](https://www.learnpython.org/en/Loops)
- [If statement tutorial](https://www.learnpython.org/en/Conditions)

- [Functions sheet sheet](https://github.com/ehmatthes/pcc/releases/download/v1.0.0/beginners_python_cheat_sheet_pcc_functions.pdf)
- [Functions tutorial](https://www.learnpython.org/en/Functions)

- [Classes cheat sheet](https://github.com/ehmatthes/pcc/releases/download/v1.0.0/beginners_python_cheat_sheet_pcc_classes.pdf)
- [Classes tutorial](https://www.learnpython.org/en/Classes_and_Objects)

- [Jannes Python Session 1](https://www.facebook.com/tsrotterdam/videos/2028379084105883/)
- [Jannes Python Session 2](https://www.facebook.com/tsrotterdam/videos/2038370389773419/)
...
- [Data analysis with Python tutorial](https://www.dataquest.io/blog/pandas-python-tutorial/)
- [Introduction to Pandas datastructures](http://www.gregreda.com/2013/10/26/intro-to-pandas-data-structures/)
...
## Kaggle 
- [How to use Kaggle Kernels](https://www.kaggle.com/t/2f193bb7f7244061b0811d60fb895c14)
